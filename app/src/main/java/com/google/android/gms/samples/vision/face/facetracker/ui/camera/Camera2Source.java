...
public class Camera2Source {
    ...
    private OnPreviewListener mListener = null;

    public interface OnPreviewListener {
        void onPreviewFrame(ImageReader reader);
    }

    public void setPreviewCallback(Camera2Source.OnPreviewListener listener) {
        mListener = listener;
    }
    ...
    /**
     * A {@link Semaphore} tㅠo prevent the app from exiting before closing the camera.
     */
    ...
    private final ImageReader.OnImageAvailableListener mOnPreviewAvailableListener = new ImageReader.OnImageAvailableListener() {
        ...
        public void onImageAvailable(ImageReader reader) {
            if (mListener != null) {
                mListener.onPreviewFrame(reader);
            }
